...
CREATE TABLE `mam_project`  (
  ...
  `leaderName` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '负责人名称',
...
) ENGINE = InnoDB AUTO_INCREMENT = 20 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '媒资项目表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mam_task`  (
  ...
  `projectName` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '归属项目名称',
  `cataloger` bigint(0) NULL DEFAULT NULL COMMENT '编目员账户',
  `catalogerName` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '编目员名称',
  `auditor` bigint(0) NULL DEFAULT NULL COMMENT '审核员账户',
  `auditorName` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '审核员名称',
  `status` varchar(5) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务状态，0：编目中、1：待修改、2：审核中、3：完成',
  `deleted` int(0) NULL DEFAULT 0 COMMENT '逻辑删除位',
  `videoInfoId` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '对应视频信息id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '媒资任务表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `mam_user`  (
  `account` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户账户',
  ...
  `role` varchar(15) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '角色权限',
  `deleted` int(0) NULL DEFAULT 0 COMMENT '逻辑删除位',
  PRIMARY KEY (`account`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '媒资用户表' ROW_FORMAT = Dynamic;
